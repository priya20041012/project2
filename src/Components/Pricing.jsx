...
<section className="py-6 dark:bg-gray-100 dark:text-gray-900">
	<div className="container mx-auto p-4 sm:p-10">
		<div className="mb-16 space-y-4 text-center">
			...
			<div>
				<button onClick={()=>navigate('/Review')} className="px-4 py-1 font-semibold border rounded-l-lg dark:bg-violet-600 dark:border-violet-600 dark:text-gray-50">Monthly</button>
				<button onClick={()=>navigate('/Table')} className="px-4 py-1 border rounded-r-lg dark:border-violet-600">Annually</button>
			</div>
		</div>
